...
import { PostGetAll, PostStatusChange } from "../../Service/PostService"
...
export const PostPage: React.FC<AuxProps> = () => {
    ...
    const [showCommnt, setShowCommnt] = useState<boolean>(false);
    const [isPostModal, setIsPostModal] = useState<boolean>(false)
    useEffect(() => {
        PostGetAll(page).then((pagedata) => {
